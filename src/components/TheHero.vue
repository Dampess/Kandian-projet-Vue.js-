    ...
    <div class="relative w-full mx-auto">
        <div class="relative" @mouseover="showCaption = true" @mouseleave="showCaption = false">
            ...
            <div :class="{ 'hidden': isSmallScreen }">
                ...
                <div class="absolute bottom-2 right-16 flex justify-center items-center">
        ...
        async fetchMovies() {
            try {
                ...
                if (data.results && data.results.length > 0) {
                    ...
                    const randomIndexes = Array.from({ length: 15 }, () => Math.floor(Math.random() * data.results.length));
